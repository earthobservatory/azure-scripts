...
export SLING_RELEASE_NUMBER=release-20180129 # This release number should be the same as the spyyyderman SDS package

ssh -i $KEY_FILENAME ops@${FACTOTUM_PVT_IP} "source ~/verdi/bin/activate; ~/verdi/ops/qquery/qquery/cron.py --tag=$QQUERY_RELEASE_NUMBER --sling_tag=$SLING_RELEASE_NUMBER asf"
